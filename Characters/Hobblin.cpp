...
void Hobblin::animationFilmChange ( void ) {
	this->setFilm(
		terrain->getFilm(ITEM_HOBBLIN_ID, direction)
	);
}

bool Hobblin::collisionDetect ( uint8_t direction ) {
	uint16_t x , y;
...
void Hobblin::handleCollision ( void ) {
...
Hobblin::Hobblin ( Terrain *terrain, uint16_t ID )  : Bot(terrain,ID)
{
